...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description ref={ref} className={cn('text-[13px] leading-relaxed text-ink-muted', className)} {...props} />
))
