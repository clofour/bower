...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden bg-canvas">
        ...
        <div className="grid w-full max-w-5xl items-center gap-12 lg:grid-cols-[1fr_380px] lg:gap-20">
          ...
          <div className="max-w-md">
            ...
            <h1 className="mt-10 text-[40px] font-bold leading-[1.05] tracking-tightest">
              Welcome <span className="italic text-brand-600">back</span>.
            </h1>
      ...
      <footer className="relative z-10 flex flex-wrap items-center justify-between gap-3 px-6 pb-6 text-xs text-ink-muted">
